...
const issueRecordSchema = new mongoose.Schema(
  {
    ...
    libraryCard: { type: mongoose.Schema.Types.ObjectId, ref: 'LibraryCard', required: true },
    issuedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true },
    returnedTo: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
    issueDate: { type: Date, default: Date.now },
    dueDate: { type: Date, required: true },
    // Permanent card support (semester based + grace period)
    // For temporary issues these stay null.
